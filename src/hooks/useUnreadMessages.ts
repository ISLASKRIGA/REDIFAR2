...
export const useUnreadMessages = () => {
  ...
  // Recontar al volver a la pestaña/ventana
  useEffect(() => {
    const onVisible = () => {
  ...
  // Tiempo real: INSERT y UPDATE(read_at) SOLO para el receptor actual
  useEffect(() => {
    if (!currentHospital?.id) return;
